...
/**
 * Form Phone EditText ViewRenderer
 *
 ...
 * @version 1.0
 */
class FormPhoneEditTextViewRenderer(private val formBuilder: FormBuildHelper, @LayoutRes private val layoutID: Int?) : BaseFormViewRenderer() {
    val viewRenderer = ViewRenderer(layoutID
            ?: R.layout.form_element, FormPhoneEditTextElement::class.java) { model, finder: FormViewFinder, _ ->
    ...
    private fun setEditTextFocusEnabled(model: FormPhoneEditTextElement,
