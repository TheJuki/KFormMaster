 ...
 * @version 1.0
 */
class FormSegmentedViewRenderer(private val formBuilder: FormBuildHelper, @LayoutRes private val layoutID: Int?) : BaseFormViewRenderer() {
    val viewRenderer = ViewRenderer(layoutID
            ?: R.layout.form_element_segmented, FormSegmentedElement::class.java) { model, finder: FormViewFinder, _ ->
