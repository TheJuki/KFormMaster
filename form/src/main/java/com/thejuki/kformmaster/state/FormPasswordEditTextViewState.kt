...
/**
 * Form Password EditText ViewState
 *
 * View State for [FormPasswordEditTextElement]
 *
 * @author **TheJuki** ([GitHub](https://github.com/TheJuki))
 * @version 1.0
 */
class FormPasswordEditTextViewState(holder: ViewHolder) : BaseFormViewState(holder) {
