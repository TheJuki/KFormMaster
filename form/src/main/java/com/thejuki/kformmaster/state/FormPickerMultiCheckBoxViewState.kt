...
/**
 * Form Picker MultiCheckBox ViewState
 *
 * View State for [FormPickerMultiCheckBoxElement]
 *
 * @author **TheJuki** ([GitHub](https://github.com/TheJuki))
 * @version 1.0
 */
class FormPickerMultiCheckBoxViewState(holder: ViewHolder) : BaseFormViewState(holder) {
