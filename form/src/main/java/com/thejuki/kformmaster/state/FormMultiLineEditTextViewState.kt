...
/**
 * Form MultiLine EditText ViewState
 *
 * View State for [FormMultiLineEditTextElement]
 *
 * @author **TheJuki** ([GitHub](https://github.com/TheJuki))
 * @version 1.0
 */
class FormMultiLineEditTextViewState(holder: ViewHolder) : BaseFormViewState(holder) {
